        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {sections.map((section, index) => (
            ...
            >
              ...
              <Button
                variant="primary"
                className="culture-resource-button w-full inline-flex items-center justify-center rounded-lg font-bold bg-[#135DCD] text-white hover:bg-[#D75220] border-2 border-[#135DCD]"
                onClick={onExplore}
              >
                {t('explore.cta')}
              </Button>
